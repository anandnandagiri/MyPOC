...
namespace GooglePeopleAPI.Helpers
{
  ...
  <body>
    ...
    <script type='text/javascript'>
      ...
      //if (window.opener) { window.opener.checkToken(); }
        ...
        /// </summary>
        public GoogleLocalServerCodeReceiver() : this(DefaultClosePageResponse) { }
        ...
        //Anand Modified Port 0 to 4433 in debug mode
        // Make sure you Port 4433 is not been used                         
        private static int GetRandomUnusedPort()
        {
#if DEBUG
            var listener = new TcpListener(IPAddress.Loopback, 4433);
#else
        ...
        //Anand preprocessor added below || NETSTANDARD2_1 || NETCOREAPP3_0 || NETCOREAPP3_1
#if NETSTANDARD1_3 || NETSTANDARD2_0 || NETSTANDARD2_1 || NETCOREAPP3_0 || NETCOREAPP3_1
